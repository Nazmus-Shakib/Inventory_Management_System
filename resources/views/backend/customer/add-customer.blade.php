        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Customers</h1></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Add Customers
                <a class="btn btn-primary float-right btn-sm" href="{{route('customers.view')}}"><i class="fa fa-list"></i> Customers List</a>
                </h3>
              </div><!-- /.card-header -->

              ...
              <table id="example1" class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    @if($purchase->status == '0')
                      <a title="Approve" id="approveBtn" class="btn btn-success btn-sm" href="{{route('purchases.approve', $purchase->id)}}"><i class="fa fa-check-circle"></i></a>
                    @endif
                    </td>
                  </tr>
                  @endforeach
